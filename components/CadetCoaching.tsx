...
export default function CadetCoaching() {
  return (
    <div
      id="cadetcoaching"
      className="min-h-screen relative inset-0 flex justify-center  bg-themeBG dark:bg-transparent xl:mt-44 py-20 flex-col overflow-x-hidden gap-10 mt-64"
    >
      <div
        aria-hidden="true"
      ...
      <div className="container grid lg:grid-cols-2 grid-cols-1 gap-10 mt-10 items-center">
        ...
        <div className="flex flex-col gap-12 order-1 lg:order-2 relative">
          ...
          <h4 className="text-4xl font-bold">
            Chance to get into Pakistan&rsquo;s most famous Cadet Colleges
          </h4>

          <p className="font-medium text-primary text-lg">
            Your child has the chance to join one of Pakistan&rsquo;s most
            prestigious cadet colleges, where discipline meets academic
            excellence. Our dedicated coaching program will prepare them for
            every step of the way, from mastering entrance exams to acing
            interviews. We focus on building strong foundational skills,
            boosting confidence, and nurturing the qualities that these elite
            institutions seek.
          </p>

          <p className="font-medium text-primary text-lg">
            With personalized guidance, your child will not only be ready for
            the challenges ahead but will also develop a mindset that will serve
            them throughout their academic and professional life. Invest in
            their future today, and watch them grow into tomorrow&rsquos;s
            leaders.
          </p>
