        ...
        >
            ...
            <div className="container mt-10 mb-20">
                <h3 className=" xl:text-6xl font-bold  md:text-5xl max-w-5xl text-4xl text-center text-primary mx-auto ">
                    Make Your Child’s Cadet College Dream a Reality
                </h3>
            </div>
            ...
            <div className="container grid lg:grid-cols-2 grid-cols-1 gap-10 mt-10 items-center">
                ...
                <div className="flex flex-col gap-12 order-1 lg:order-2 relative">
                    ...
                    <h4 className="text-4xl font-bold">
                        Chance to get into Pakistan's most famous Cadet Colleges
                    </h4>
                    <p className="font-medium text-primary text-lg">
                        Your child has the chance to join one of Pakistan's most
                        prestigious cadet colleges, where discipline meets
                        academic excellence. Our dedicated coaching program will
                        prepare them for every step of the way, from mastering
                        entrance exams to acing interviews. We focus on building
                        strong foundational skills, boosting confidence, and
                        nurturing the qualities that these elite institutions
                        seek.
                    </p>
                    <p className="font-medium text-primary text-lg">
                        ...
                        watch them grow into tomorrow's leaders.
                    </p>
                    <Link
                        href={'#'}
