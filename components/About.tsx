      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2  relative py-20 gap-10">
        ...
        <div className="flex flex-col gap-5">
          <p className="lg:text-xl text-lg font-light lg:max-w-[600px]">
            At <span className="">Ikram Forces Academy</span>, our mission is to
            help every student reach their fullest potential. Through focused
            coaching, we build confidence, discipline, and a strong academic
            foundation.
          </p>

          <p className="lg:text-xl text-lg font-light lg:max-w-[600px]">
            Our tailored tuition programs are crafted to prepare young minds for
            the unique challenges of cadet college and beyond, ensuring they are
